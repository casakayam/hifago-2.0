...
- **Identité anonyme — spec 31 ÉCRITE le 2026-09-10, à implémenter** (`docs/specs/31-identite-anonyme.md`, 4 tranches, 8 décisions). ⚠️ Deux points y restent ouverts : le critère de purge (Jérôme a dit « si pas de commande », la question incluait « ni panier ») et le nom du compte technique des réservations manuelles.
