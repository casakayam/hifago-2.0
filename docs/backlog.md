...
- **Chantier front vitrine** — les points ouverts du parcours client cible sont groupés dans `docs/01-cahier-des-charges-client.md` §2f (recherche géo différée, forme du voucher, dispo PMS en recherche datée). ⚠️ « Rattachement d'une commande invitée à un compte » en est RETIRÉ : livré le 2026-09-10 par la spec 33 (`attach_orders_to_account`, appelée depuis `/auth/callback` après vérification de l'email — ne rattache que des commandes encore détenues par une identité anonyme). ⚠️ « Source du contact d'un établissement » en est RETIRÉ : tranché le 2026-09-08 (colonne `establishments.contact_phone`, spec 30 §3.2) — `partners.phone` était le mauvais candidat, 0/36 rempli. « Plafonds du panier » en est RETIRÉ aussi (trouvé périmé le 2026-09-10 en préparant spec 32) : §3e du même cahier l'avait déjà tranché le 2026-09-07 (plafond global, valeurs 12/36/40/20) — §2f n'avait jamais été mis à jour le même jour. Le vrai point ouvert n'est pas la forme du plafond mais sa valeur, jamais codée (cf. spec 32 §10).
